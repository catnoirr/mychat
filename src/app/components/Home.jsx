    ...
    <div className="flex items-center justify-center  ">
      <div className="relative bg-black text-white  w-full h-screen p-6 flex flex-col lg:flex-row  lg:items-center lg:justify-between lg:w-full lg:px-20 shadow-lg">
        ...
        <div className="text-center mt-40 space-y-4 lg:text-left lg:mt-0 lg:w-1/2">
          <h1 className="text-2xl font-semibold sm:text-3xl md:text-4xl lg:text-5xl">It's easy talking to your friends with Chatdong</h1>
          <p className="text-gray-400 text-sm sm:text-base md:text-lg lg:text-xl">Call Your Friend Simply And Simple With Chatdong</p>
        </div>

        {/* Right side: Get Started button */}
        <div className="text-center mt-10 lg:mt-0 lg:w-1/2 lg:text-right">
          <button className="mb-10 px-6 py-3 bg-yellow-200 text-black font-medium rounded-full shadow-md hover:bg-yellow-300 transition-colors sm:px-8 sm:py-4 md:px-10 md:py-5 lg:px-12 lg:py-6">
            Get Started
          </button>
        </div>
